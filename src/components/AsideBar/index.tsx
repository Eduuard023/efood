  ...
  return (
    <AsideContainer className={isOpen ? 'is-open' : ''}>
      ...
      <SideBar>
        ...
        {view === 'delivery' && (
          <>
            <FormsTitles>Entrega</FormsTitles>
            <Formik
              initialValues={{
                customer: '',
                address: '',
        ...
        {view === 'payment' && (
          <>
            <FormsTitles>
              ...
              <span>{formataPreco(getCartTotal())}</span>
            </FormsTitles>
            <Formik
              initialValues={{
                cardOwner: '',
                ...
                <StyledForm>
                  <label htmlFor="cardOwner">
                    ...
                    {errors.cardOwner && touched.cardOwner ? (
                      <div>{errors.cardOwner}</div>
                    ) : null}
                  </label>
                  <CardNumber style={{ gap: '30px' }}>
                  ...
                  <Button name="add" onClick={() => setView('delivery')}>
